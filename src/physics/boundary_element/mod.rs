...
pub use flux_density::{flux_density_triangle, triangle_flux_density_basis};
pub use inductance::{
...
pub use vector_potential::{triangle_vector_potential_basis, vector_potential_triangle};
