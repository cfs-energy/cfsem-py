...
lim_T1 = sp.limit(T1, dx, 0)
lim_T2 = sp.limit(T2, dx, 0)
lim_T3 = sp.limit(T3, dx, 0)
lim_T4 = sp.limit(T4, dx, 0)
lim_T5 = sp.limit(T5, dx, 0)
lim_T6 = sp.limit(T6, dx, 0)
lim_T7 = sp.limit(T7, dx, 0)
lim_T8 = sp.limit(T8, dx, 0)
lim_T9 = sp.limit(T9, dx, 0)

phi_lim_limit = sp.together(lim_T1 + lim_T2 + lim_T3 + lim_T4 + lim_T5 +
                            lim_T6 + lim_T7 + lim_T8 + lim_T9)
...
phi_lim_series = series_T1 + series_T2 + series_T3 + series_T4 + series_T5 + \
                 series_T6 + series_T7 + series_T8 + series_T9
