...
# # Directly keep linear terms only
# a1_expr = a            # constant
# b1_expr = b            # for limit dy→0, keep only leading term b (ignore -dy since linear term is explicit later)

# a2_expr = a            # constant
# b2_expr = dy           # already linear

# a3_expr = dy           # already linear
# b3_expr = a            # constant

# a4_expr = a*dy/sp.sqrt(a**2 + b**2)   # linear
# b4_expr = b*dy/sp.sqrt(a**2 + b**2)   # linear

# a5_expr = a*dy/sp.sqrt(a**2 + b**2)   # linear
# b5_expr = sp.sqrt(a**2 + b**2)        # constant
...
series_T1 = linear_term(sp.expand(T1))
print(pycode(series_T1))
series_T2 = linear_term(sp.expand(T2))
print(pycode(series_T2))
series_T3 = linear_term(sp.expand(T3))
print(pycode(series_T3))
series_T4 = linear_term(sp.expand(T4))
print(pycode(series_T4))
series_T5 = linear_term(sp.expand(T5))
print(pycode(series_T5))
series_T6 = linear_term(sp.expand(T6))
print(pycode(series_T6))
series_T7 = linear_term(sp.expand(T7))
print(pycode(series_T7))
series_T8 = linear_term(sp.expand(T8))
...
# Hy_sigma1_improved = sp.trigsimp(Hy_sigma1_lin)
